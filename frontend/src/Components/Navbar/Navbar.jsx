...
const Navbar = () => {
    ...
    return (
        <>
            <motion.nav
                className={`fixed w-full top-0 left-0 z-50 h-16 transition-all duration-300 ${scrolled
            ...
            >
                <div className="container mx-auto flex justify-between items-center py-1 px-4 sm:px-6">
                    {/* Logo */}
                    <motion.div
